            ...
            <div class="d-flex align-items-center logo-box justify-content-start bx-1">
                ...
                <a href="" class="logo">
                    ...
                    <div class="logo-mini w-30">
                        <span class="light-logo"><img src="{{ asset('backend/images/logo-letter.png') }}"
                                alt="logo"></span>
                        <span class="dark-logo"><img src="{{ asset('backend/images/logo-letter.png') }}"
                                alt="logo"></span>
                    </div>
                    <div class="logo-lg">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            {{-- <a href="#" class="waves-effect waves-light dropdown-toggle btn-primary-light"
                                ...
                                @if(Auth::user()->profile_image && file_exists(public_path('storage/profile_images/' .
                                Auth::user()->profile_image)))
                                <img src="{{ asset('storage/profile_images/' . Auth::user()->profile_image) }}"
                                    alt="Profile Image" class="rounded-circle profile-img" width="100" height="100">
                                @else
                                <img src="{{ asset('backend/images/user.png') }}" alt="Default User"
                        ...
                        <ul class="sidebar-menu" data-widget="tree">
                            ...
                            <li class="treeview">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <li><a href=""><i class="icon-Commit"><span
                                                    class="path1"></span><span class="path2"></span></i>Change
                                            Password</a></li>
                                    <li><a href=""><i class="icon-Commit"><span
                                                    class="path1"></span><span class="path2"></span></i>Change Profile
                                            pics</a></li>
                            ...
                            <li class="treeview">
                                <a href="#">
                                    ...
                                    <span class="mr-4">Investor verification </span>
