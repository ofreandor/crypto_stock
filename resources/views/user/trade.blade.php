    ...
    <main class="main-content col-12">
                ...
                <div class="container-fluid navbar-inner">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto navbar-list mb-2 mb-lg-0 align-items-center">
                            <li>
                                <button class="btn btn-outline-danger mx-2">Demo Trade</button>
                            </li>

                            <li>
                                <button class="btn btn-outline-success ">Live Trade</button>
                            </li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    ...
                                    <li class="border-0"><a class="dropdown-item" href="">Logout</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
        ...
        <div class="container content-inner pb-0">
            <div class="row py-4"></div>
              ...
              <div class="row d-flex align-items-stretch py-5 mx-3">
                <!-- Trading Chart Column -->
                <div class="col-md-7 mx-auto mb-4" style="margin-left: 30px;">
                    <!-- Increased margin-left here -->
